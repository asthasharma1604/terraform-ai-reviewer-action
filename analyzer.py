...
def build_review_sections(review_data):
    ...
    dangerous_summary = ""
    if review_data.dangerous_changes:
    ...
    security_summary = ""
    if review_data.security_issues:
    ...
    if review_data.architecture_suggestions:
    ...
    fixes_summary = ""
    if review_data.fix_suggestions:
